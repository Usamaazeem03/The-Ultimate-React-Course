...
class App extends React.Component {
  ...
  // like useEffect({}, [])
  componentDidMount() {
    this.setState({ location: localStorage.getItem("lastLocation") || "" });
  }
  ...
  render() {
    const setLocation = (e) => this.setState({ location: e.target.value });

    return (
      <div className="app">
        <h1>Classy Weather</h1>
        <Input location={this.state.location} onChangeLocation={setLocation} />
